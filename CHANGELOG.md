...
- **BREAKING:** Project forked and renamed from `react-financial-charts` to `react-fincharts`
- **BREAKING:** All package names changed from `@react-financial-charts/*` to `@react-fincharts/*`
- **BREAKING:** Main package renamed from `react-financial-charts` to `react-fincharts`
- Updated to support React 17, 18, and 19
- Modernized component lifecycle methods for React 18+ compatibility
- Fixed context propagation issues in tooltips and indicators
- Fixed annotation positioning during zoom/pan operations
- Cleaned up monorepo structure (removed individual package node_modules)

### Added

- Support for React 19
- Improved error handling in tooltips
- Better zoom/pan responsiveness for annotations

### Fixed

- Tooltip rendering errors when chartConfig is undefined
- Component re-rendering issues during zoom operations
- Annotation synchronization with chart transformations
- ESLint configuration and build process

---

**Previous versions (original react-financial-charts project):**
