...
**Note:** Version bump only for package @react-fincharts/annotations
...
- **Annotations**: Fixed zoom/pan coordination issues in annotation components
...
- Fixed annotation rendering and interaction bugs
- Improved zoom/pan coordination
