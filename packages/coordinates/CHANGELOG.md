...
**Note:** Version bump only for package @react-fincharts/coordinates
...
- **Coordinates**: Fixed cursor and coordinate rendering issues
...
- Enhanced coordinate system performance
- Fixed cursor tracking and coordinate display bugs
