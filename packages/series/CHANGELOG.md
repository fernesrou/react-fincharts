...
**Note:** Version bump only for package @react-fincharts/series
...
- **Series**: Fixed rendering issues in RSI, AlternatingFill, and other series components
...
- Enhanced series rendering performance
- Fixed undefined property access bugs
