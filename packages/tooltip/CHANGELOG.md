...
**Note:** Version bump only for package @react-fincharts/tooltip
...
- **Tooltips**: Fixed tooltip rendering and positioning issues
...
- Enhanced tooltip performance and positioning
